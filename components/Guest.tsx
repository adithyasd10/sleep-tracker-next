    ...
    <div className="font-sans bg-[#0a0a0a] text-white">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between px-4 sm:px-8 md:px-16 py-16 md:py-24 gap-8 max-w-7xl mx-auto">
        <div className="flex-1">
          <h1 className="text-3xl sm:text-4xl md:text-5xl 2xl:text-6xl font-bold mb-4 bg-gradient-to-r from-cyan-500 via-teal-400 to-emerald-500 bg-clip-text text-transparent">
            Welcome to SleepTracker
          </h1>
          <p className="text-base sm:text-lg md:text-xl 2xl:text-2xl mb-6 text-gray-300">
            Track your sleep, improve your health, and wake up feeling refreshed with SleepTracker.
          </p>
          <SignInButton>
            <button className="w-full sm:w-auto bg-gradient-to-r from-cyan-500 via-teal-400 to-emerald-500 hover:from-cyan-600 hover:via-teal-500 hover:to-emerald-600 text-white px-5 py-3 rounded-md font-medium cursor-pointer transition">
              Get Started
            </button>
          </SignInButton>
        </div>
        <div className="flex-1 flex justify-center items-center">
          <Image
            ...
            width={600}
            height={400}
            className="w-full max-w-xs sm:max-w-md md:max-w-lg lg:max-w-xl rounded-tl-3xl rounded-br-3xl shadow-lg"
          />
        </div>
      </div>

      {/* Divider */}
      <div className="h-1 bg-emerald-500/20 mx-4 sm:mx-8" />

      {/* FAQ Section */}
      <div className="py-16 px-4 sm:px-8 md:px-16 bg-[#111827] max-w-screen mx-auto  ">
        <h2 className="text-2xl sm:text-3xl md:text-4xl 2xl:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-cyan-500 via-teal-400 to-emerald-500 bg-clip-text text-transparent">
          Frequently Asked Questions
        </h2>
        <div className="space-y-10 text-gray-300">
          <div>
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-cyan-400">
          ...
          <div>
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-teal-400">
              How does it work?
            </h3>
            <p className="mt-2">
          ...
          <div>
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-emerald-400">
      ...
      <div className="py-16 px-4 sm:px-8 md:px-16 bg-[#0a0a0a] max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl md:text-4xl 2xl:text-5xl font-bold text-center mb-12 bg-gradient-to-r from-cyan-500 via-teal-400 to-emerald-500 bg-clip-text text-transparent">
          What Our Users Say
        </h2>
